...
**Bug**: S1 — rapid follow-ups must not duplicate user events (PRIMARY)

```
EnsureGrokSync starts single worker
...
3. Schedule turn 2 (user + assistant + `turn_completed`) at 400ms (17s overlap window simulated).
