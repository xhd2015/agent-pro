...
// loghttp is a copy of the loghttp.go from main package to avoid main↔server import cycles.
// This is intentionally a private implementation detail of the server package.
