...
doctest test ./agent/llm/llm-mock/tests/run-codex                    # discovery (skips labeled e2e/heavy/slow)
doctest test --label e2e ./agent/llm/llm-mock/tests/run-codex
doctest test --label-all ./agent/llm/llm-mock/tests/run-codex
