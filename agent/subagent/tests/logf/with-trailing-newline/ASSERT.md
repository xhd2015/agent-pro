## Expected
- Output matches `[YYYY-MM-DDTHH:MM:SS] hello\n` (timestamp prefix, message, exactly one newline).
- The trailing newline from the input is preserved, no second newline appended.
