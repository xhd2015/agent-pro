...
//
// The intent-route agent is an intent router that classifies user input
// and delegates to the appropriate specialist agent or skill. It
// recognizes New Features, Flash Ideas, Issues/Bugs, Questions, and
// Others. It auto-detects the parent agent runner (opencode, pi, codex,
...
var help = `
Usage: intent-route [OPTIONS] <prompt>

An intent router that classifies user input and delegates to the appropriate
specialist agent or skill. Recognizes New Features, Flash Ideas, Issues/Bugs,
Questions, and Others. Delegates to the parent agent runner (auto-detected)
for LLM calls.
...
Options:
  ...
  --list-sessions          list all intent-route sessions
  --session-base <dir>     override sessions directory
  -h, --help               show this help
`

const defaultModelEnv = "AGENT_PRO_SUBAGENT_INTENT_ROUTE_MODEL"

// Config holds all customizable configuration for the intent-route agent.
