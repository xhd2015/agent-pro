# agent-pro consolidate-code Registration Tests

Doc-style tests verifying `consolidate-code` is registered in `agent-pro skills`.
...
├── register/                          # skill show succeeds for consolidate-code
└── list/                              # agent-pro skills lists consolidate-code
```
...
doctest test ./agents/consolidate-code/tests/agent-pro/...                    # discovery (skips labeled e2e/heavy/slow)
doctest test --label e2e ./agents/consolidate-code/tests/agent-pro/...
doctest test --label-all ./agents/consolidate-code/tests/agent-pro/...

doctest vet ./agents/consolidate-code/tests/agent-pro
doctest test -v ./agents/consolidate-code/tests/agent-pro/...
```
