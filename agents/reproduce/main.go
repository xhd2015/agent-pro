...
import (
	...
	"github.com/xhd2015/agent-pro/agents/reproduce/run"
...
const skillName = "reproduce"

const help = `
Usage: reproduce [OPTIONS] <prompt>

A bug reproduction specialist for understanding and reproducing issues
locally. Breaks down complex issues into steps and builds minimal
