...
doctest test ./agents/run-the-loop/tests/agent-pro/...                    # discovery (skips labeled e2e/heavy/slow)
doctest test --label e2e ./agents/run-the-loop/tests/agent-pro/...
doctest test --label-all ./agents/run-the-loop/tests/agent-pro/...
