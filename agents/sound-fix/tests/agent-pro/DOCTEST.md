# agent-pro sound-fix Registration Tests

Doc-style tests verifying `sound-fix` is registered in `agent-pro skills`.
...
├── register/                          # skill show succeeds for sound-fix
└── list/                              # agent-pro skills lists sound-fix
```
...
doctest test ./agents/sound-fix/tests/agent-pro/...                    # discovery (skips labeled e2e/heavy/slow)
doctest test --label e2e ./agents/sound-fix/tests/agent-pro/...
doctest test --label-all ./agents/sound-fix/tests/agent-pro/...

doctest vet ./agents/sound-fix/tests/agent-pro
doctest test -v ./agents/sound-fix/tests/agent-pro/...
```
