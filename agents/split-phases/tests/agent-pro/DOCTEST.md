...
doctest test ./agents/split-phases/tests/agent-pro/...                    # discovery (skips labeled e2e/heavy/slow)
doctest test --label e2e ./agents/split-phases/tests/agent-pro/...
doctest test --label-all ./agents/split-phases/tests/agent-pro/...
