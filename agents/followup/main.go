...
import (
	...
	"github.com/xhd2015/agent-pro/agents/followup/run"
...
const skillName = "followup"

const help = `
Usage: followup [OPTIONS] <prompt>

A clarification-phase followup agent. Stays in discussion mode without
moving to implementation. Delegates to the parent agent runner (auto-detected)
for LLM calls.
