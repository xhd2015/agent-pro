...
doctest test ./agents/followup/tests/agent-pro/...                    # discovery (skips labeled e2e/heavy/slow)
doctest test --label e2e ./agents/followup/tests/agent-pro/...
doctest test --label-all ./agents/followup/tests/agent-pro/...
