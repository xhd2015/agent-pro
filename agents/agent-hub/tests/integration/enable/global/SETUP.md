## Steps
1. Pre-create `agent-hub.ts.disabled` in global plugins dir.
2. Run `agent-hub integration opencode enable --global`.
...
func Setup(t *testing.T, req *Request) error {
    ...
    req.Args = []string{"integration", "opencode", "enable", "--global"}
