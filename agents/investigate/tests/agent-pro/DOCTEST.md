...
doctest test ./agents/investigate/tests/agent-pro/...                    # discovery (skips labeled e2e/heavy/slow)
doctest test --label e2e ./agents/investigate/tests/agent-pro/...
doctest test --label-all ./agents/investigate/tests/agent-pro/...
