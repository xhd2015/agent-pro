...
func Setup(t *testing.T, d *session.Doctest, req *Request) error {
    ...
    mockJSON := `{"version":"agent-pro.fake-runner.v1","runner":"fake-opencode","session_id":"sess_grep_nf","llm_events":[{"type":"tool_call","tool":"grep","tool_input":{"pattern":"ZZZZ_NO_MATCH_ZZZZ","path":"` + searchDir + `"}}]}`
