...
func Setup(t *testing.T, req *Request) error {
    ...
    mockJSON := `{"version":"agent-pro.fake-runner.v1","runner":"fake-opencode","session_id":"sess_read_mock","llm_events":[{"type":"tool_call","tool":"read","mock":{"content":"fake read content","exit_code":0}}]}`
