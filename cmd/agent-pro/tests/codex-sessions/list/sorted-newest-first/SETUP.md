...
**Feature**: list sorts sessions by started_at descending

```
# three sessions with non-chronological write order
writeRolloutSession(middle, oldest, newest) -> sessions.List

# returned order follows started_at not file creation order
[]Session sorted newest first
```

## Preconditions

- Three sessions have known timestamps on different hours.
...
func Setup(t *testing.T, d *session.Doctest, req *Request) error {
	...
	writeRolloutSession(t, req.CodexHome,
		...
		"2026-06-21T12:00:00.000Z", "/tmp/mid")
	writeRolloutSession(t, req.CodexHome,
		"01900003-0000-7000-8000-000000000001",
		"2026-06-21T10:00:00.000Z", "/tmp/old")
	writeRolloutSession(t, req.CodexHome,
		"01900003-0000-7000-8000-000000000003",
		"2026-06-21T14:00:00.000Z", "/tmp/new")
	return nil
}
```