...
- Session-scoped cache under `$TMPDIR/grok-discovery-race-doctest-<DOCTEST_SESSION_ID>/`
...
func sessionCacheDir() string {
	return filepath.Join(os.TempDir(), "grok-discovery-race-doctest-"+DOCTEST_SESSION_ID)
}
