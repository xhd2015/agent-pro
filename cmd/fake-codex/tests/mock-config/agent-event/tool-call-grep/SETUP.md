...
func Setup(t *testing.T, req *Request) error {
    ...
    writeMockConfig(t, req, `{"version":"agent-pro.fake-runner.v1","runner":"fake-codex","stdout_events":[{"type":"tool_call","tool":"grep","tool_input":{"pattern":"needle","path":"`+req.TempDir+`"}}]}`)
    return nil
}
```
