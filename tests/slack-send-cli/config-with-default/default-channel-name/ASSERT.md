---
label: unit
explanation: defaultChannelId name resolved via knownChannels/API
---

## Expected

- Exit code 0.
- Default channel name resolved to `C0ALE44K5J6`.
...
---
Sending to channel=C0ALE44K5J6: "name default"
