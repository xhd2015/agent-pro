---
label: unit
explanation: --config supplies token and defaultChannelId
---

## Expected

- Exit code 0.
- Default channel `C0ALE44K5J6` from config.
- Absolute config path in stdout.
...
---
Sending to channel=C0ALE44K5J6: "Hello from config"
