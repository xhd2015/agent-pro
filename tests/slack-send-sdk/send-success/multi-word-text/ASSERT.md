---
label: unit
explanation: slacktest isolated send with multi-word text
---

## Expected

- Exit code 0.
- Sending line contains full quoted text with spaces.
- Stderr empty.
...
---
Sending to channel=C0ALE44K5J6: "Hello from Go debug script"
